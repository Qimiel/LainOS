	...
	for (int i = 0; i < this->numOfButtons; i++) {
		...
		switch (this->buttonTypes[i]) {
			...
			case 3:
				...
				gc->PutText("NTE", buttonx+1, buttony+21, 0x40);
				gc->PutText("NTE", buttonx, buttony+20, 0x3f);
				break;
			//files
			case 16:
	...
	if (button == 1) {
		...
		switch (appType) {
			...
			case 0:
				break;
			case 1:
				desktop->CreateChild(1, "Terminal", nullptr);
				break;
			case 2:
				desktop->CreateChild(2, "Paint", nullptr);
				break;
			case 3:
				desktop->CreateChild(3, "Notepad", nullptr);
				break;
			case 16:
				widget = desktop->CreateChild(3, "Notepad", nullptr);
				win = (Window*)widget;
